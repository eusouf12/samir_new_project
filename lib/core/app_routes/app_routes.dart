...
import '../../view/screens/host_part/collaboration_screen/views/negotiation_screen.dart';
...
import '../../view/screens/host_part/host_deal_screen/views/host_deal_overview_screen.dart';
...
class AppRoutes {
 ...
 static const String infShowListingScreen = "/InfShowListingScreen";
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: hostUpdateDealScreen, page: () => HostUpdateDealScreen()),
