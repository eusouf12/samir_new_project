...
class InfCustomTotalDealsCard extends StatelessWidget {
  ...
  const InfCustomTotalDealsCard({super.key, this.profileImg, this.fullName, this.userName, this.userImg, this.deliverablesText, this.paymentText, this.progressText, this.durationText, this.viewDetailsButton, this.messageButton});
