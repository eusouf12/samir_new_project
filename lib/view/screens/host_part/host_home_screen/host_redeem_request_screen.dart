...
class HostRedeemRequestScreen extends StatelessWidget {
   HostRedeemRequestScreen({super.key});

  final hostHomeController = Get.find<HostHomeController>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomRoyelAppbar(leftIcon: true, titleName: "Redeem Requests"),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            CustomText(
              text:
              "Manage stay requests from influencers who wish to redeem their earned Night Credits.",
              fontSize: 14,
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CustomText(text: "Credits Used:",fontSize: 14,fontWeight: FontWeight.w400,color: AppColors.textClr,),
                        CustomText(text: "3 Night Credits",fontSize: 14,fontWeight: FontWeight.w500,),
                      ],
                    ),
                    SizedBox(height: 12),
                    Row(
