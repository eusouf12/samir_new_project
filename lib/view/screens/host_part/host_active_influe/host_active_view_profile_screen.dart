...
import 'package:Hostinflu/view/screens/host_part/host_active_influe/widgets/custom_past_deals_card.dart';
import 'package:Hostinflu/view/screens/host_part/host_active_influe/widgets/custom_review_card.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Obx(() {
                if (role == "host") {
                  if (collaborationController.singleUserCollaborationStatus.value == Status.loading && collaborationController.isReviewLoading.value) {
                    return Center(child: CustomLoader(color: AppColors.primary),);
                  }
                }
                else {
                  if (controller.rxListingStatus.value == Status.loading && collaborationController.isReviewLoading.value) {
